...
import TransactionHistoriesList from './TransactionHistoriesList';

describe('TransactionHistoriesList', () => {
    const transactions = [{
        amount: 1220302,
    ...
    it('should show two transaction in list and first one with key T00000006 ', () => {
        const wrapper = shallow(<TransactionHistoriesList data={transactions}/>);
